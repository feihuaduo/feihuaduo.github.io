/* ----------------------------------
jQuery Timelinr 1.0.0
tested with jQuery v1.6+

作者：王冠冠
基于jQuery Timelinr之前版本上进行修改，新增allScroll属性，用于单页面水平和垂直同时共存；
---------------------------------- */
...
jQuery.fn.timelinr = function(options) {
  ...
  settings = jQuery.extend(
    {
      orientation: "allScroll", // horizontal 水平滚动， vertical 垂直滚动，allScroll 单页面可拥有水平和垂直滚动
      ...
      if (settings.orientation == "horizontal") {
        ...
        if (
          ...
          if (!$(settings.issuesDiv).is(":animated")) {
            ...
            $(settings.issuesDiv + " li." + settings.issuesSelectedClass)
              .removeClass(settings.issuesSelectedClass)
              .next()
              .fadeTo(settings.issuesTransparencySpeed, 1)
              .addClass(settings.issuesSelectedClass);
            ...
            $(settings.datesDiv + " a." + settings.datesSelectedClass)
        ...
        if (currentPositionIssues <= -(heightIssue * howManyIssues - heightIssue)) {
          ...
          if (!$(settings.issuesDiv).is(":animated")) {
            ...
            $(settings.datesDiv + " a." + settings.datesSelectedClass)
              .removeClass(settings.datesSelectedClass).parent().next().children().addClass(settings.datesSelectedClass);
          }
        }
      }
